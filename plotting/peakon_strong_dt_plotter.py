...
base_code = 'gahito_final_peakon_convergence_strong_dt_'
...
plt.savefig('figures/final/gahito_peakon_strong_convergence.png', bbox_extra_artists=(leg,), bbox_inches='tight')
