...
def experiment(code, Ld, tmax, resolutions=[],
    ...
    for key, value in zip(['dirname', 'Ld', 'tmax', 'ndump', 'field_ndump', 'allow_fail', 't_kick', 'sigma_kick'],
                          [dirname, Ld, tmax, ndump, field_ndump, allow_fail, t_kick, sigma_kick]):
