...
for i, (timestep, ax) in enumerate(zip(timesteps, axs)):
    ...
    ax.plot(xmin, u_xmin, color='red', linestyle='--', marker='', ms=ms, lw=lw)
    ax.plot(xmax, u_xmax, color='red', linestyle='--', marker='', ms=ms, lw=lw)
...
plt.savefig('figures/peakon_demo.png', bbox_inches='tight')
